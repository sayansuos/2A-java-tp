...
public class Password {
    ...
    public static String bruteForce6Digit(String targetHash) {
        ...
        for (int i = 0; i < 1000000; i++) {
            String tested_pwd = String.format("%06d", i);
            String hashed_pwd = hashPassword(tested_pwd);
            if (hashed_pwd.equals(targetHash)) {
                pwd = tested_pwd;
                break;
            }
        }
    ...
    public static boolean isStrongPassword(String password) {
        ...
        boolean length_condition = password.length() >= 12;
        boolean upper_condition = false;
        boolean lower_condition = false;
        boolean digit_condition = false;
        ...
        return length_condition & upper_condition & lower_condition & digit_condition & no_whitespace;
    }
    ...
    public static HashMap<String, Boolean> checkPasswordsList(ArrayList<String> passwords) {
        ...
        HashMap<String, Boolean> pwd_hashmap = new HashMap<>();
        for (String pwd: passwords){
            pwd_hashmap.put(hashPassword(pwd), isStrongPassword(pwd));
        }
